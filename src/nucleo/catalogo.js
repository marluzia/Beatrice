...
export const CATALOGO = [
  {
    ...
    itens: [
      ...
      {
        chave: "ar", nome: "Ar-condicionado", especie: "consumo",
        quantidade: "", unidade: "kwh",
        rateio: "dias", rateios: ["igual", "dias"],
        dica: "Marque só quem usa o cômodo. Em quarto dividido, o peso por dias cobra mais de quem passou mais noites lá.",
      },
      {
